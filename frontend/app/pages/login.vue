<template>
  <v-sheet
    ...
    height="100vh"
  >
    <v-card class="pa-8 rounded-xl" elevation="8" max-width="420" width="100%">
      <!-- Logo -->
      <div class="text-center mb-6">
        ...
        <p class="text-body-2 text-grey">กรุณาเข้าสู่ระบบเพื่อใช้งานระบบ</p>
      </div>
      ...
      <v-form v-model="form" @submit.prevent="onSubmit">
        ...
        <v-btn color="primary" size="large" type="submit" block class="mt-4">
          เข้าสู่ระบบ
        </v-btn>
      </v-form>
